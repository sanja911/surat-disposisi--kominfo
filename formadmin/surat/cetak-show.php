...
class PDF extends FPDF
{
    ...
    {
      // Logo
      $this->Image('../../assets/img/batankrajan.jpg',20,10);
    	...
    	// $this->Cell(60);
    	// Title
        $this->Cell(200,8,'PEMERINTAH DESA BATANKRAJAN',0,1,'C');
        $this->Cell(200,8,'KECAMATAN GEDEG, KABUPATEN MOJOKERTO',0,1,'C');
    	$this->Cell(200,8,'JAWA TIMUR',0,1,'C');
    	// Line break
    	$this->Ln(5);
...
// set penomoran
    ...
    $pdf->cell(2,7,':',0,0,'L');
    $pdf->cell(80, 7, substr(strtoupper($data_warga[0]['nama_warga']),0 , 30), 0, 1, 'L');
